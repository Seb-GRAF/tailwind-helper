...
const Home: NextPage = () => {
  ...
  return (
    <div className='relative'>
      ...
      {/* CATEGORIES */}
      <nav className='relative flex justify-between w-full gap-2 mb-4 overflow-x-auto border-b sm:justify-start sm:gap-4 sm:mb-8 border-slate-300 dark:border-slate-700'>
        <CategoryButton
