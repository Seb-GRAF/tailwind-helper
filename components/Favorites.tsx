...
const Favorites = () => {
  ...
  return (
    <div className='flex flex-col gap-4'>
      ...
      {/* GRIDS CATEGORY */}
      {!favoritesContext.isCategoryEmpty('grids') && (
        <WidgetWrapper>
          <div className='flex flex-col self-start w-full gap-4'>
            <DeleteButton category='grids' />
            <h2 className='text-xl font-semibold'>Grids</h2>
            <ul className='flex flex-col gap-4 sm:gap-2'>
              {favoritesContext?.favorites
                ?.sort((a, b) => {
                  if (a.name.toLowerCase() < b.name.toLowerCase()) return -1
      ...
      {/* IMAGES CATEGORY */}
      {!favoritesContext.isCategoryEmpty('images') && (
        <WidgetWrapper>
          <div className='flex flex-col self-start w-full gap-4'>
            <DeleteButton category='images' />
